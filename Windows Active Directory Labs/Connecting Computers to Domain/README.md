...
![Windows 10 Computer IP and DNS Configurations](Screenshots/WIN10User_Preferred DNS Server Configuration.PNG)
...
Through System Properties in Computer Name tab, `Change` from Workgroup to Domain.
